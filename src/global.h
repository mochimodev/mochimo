...
/* C/C++ compatible "extern" declarations */
#ifdef __cplusplus
extern "C" {
#endif

int Nonline;         /* number of pid's in Nodes[]                */
word32 Quorum;       /* Number of peers in get_eon() gang[MAXQUORUM] */
...
char *Bcdir;         /* block chain directory */
char *Ngdir;         /* block chain directory */
char *Spdir;         /* block chain directory */

time_t Pushtime;     /* time of last OP_MBLOCK */
time_t Utime;        /* update time for watchdog */
word8 Allowpush;     /* set by -P flag in mochimo.c */
word8 Cbits;         /* 8 capability bits */
