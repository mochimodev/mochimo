Update: Code version 1.8a is live and contains critical security updates to the Block Validator and Block Updater.  Please do not run previous versions of the code.
